...
public class Controller {
	...
	public String signUpUser(String name, String email, String password)
	{
	    ...
	    if (!isValidEmail(email))
	        return "Email address not valid. Please try different email.";
	    ...
	    if(!isValidPassword(password))
	        return "Password must be atleast 8 characters, including 1 upper case letter, 1 number and 1 symbol";
	...
	public String signInUser(String email, String password) {
	    ...
	    for (User u : theOne.mAllUsersList)
	    {
	        ...
	        {
	            // go into the database to retrieve password:
	            try
                {
	...
	public ObservableList<VideoGame> getGamesForCurrentUser()
	{
        ...
        try
        {
            ...
            for(ArrayList<String> values : resultsList)
            {
                ...
                // loop through the games, try to find a match
